...
!(async () => {
  ...
  // 助力
  let res = [], res2 = [];
  $.innerShInviteList = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/summer_movement_one.json');
  res2 = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/summer_movement.json');
  $.ShInviteLists = []
  if (ShHelpAuthorFlag) {
