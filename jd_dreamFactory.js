...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://action-1251995682.file.myqcloud.com/shareCodes/jd_updateFactoryTuanId.json")
  if (!res) res = await updateTuanIdsCDN('https://action-1251995682.file.myqcloud.com/shareCodes/jd_updateFactoryTuanId.json');
...
function updateTuanIdsCDN(url = 'https://action-1251995682.file.myqcloud.com/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    const options = {
