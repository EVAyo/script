...
[task_local]
#金榜年终奖
10 0,2 * * * jd_split.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "10 0,2 * * *" script-path=jd_split.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="10 0,2 * * *",wake-system=1,timeout=3600,script-path=jd_split.js

============小火箭=========
金榜年终奖 = type=cron,script-path=jd_split.js, cronexpr="10 0,2 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/split.json')
