...
let inviteCodes = [
  'HYXnz-ymQgqqfOzHW5h_1iZoHuKc8U0KCqx4Hv3uFvip',
  'QMyKkLX_EEj6OdzWW5gzmmvH5PtiKTrbMXHrZ-VTRm4'
]
$.shareCodesArr = [];
...
!(async () => {
  ...
  if (helpShareFlag + "" == "true") {
    console.log('如需开启优先助力[内部账号]，请设置环境变量  JD_CITY_HELPSHARE 为false\n')
  } else {
    console.log('如需开启优先助力[助力池]，请设置环境变量  JD_CITY_HELPSHARE 为true\n')
  }
