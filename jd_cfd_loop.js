...
[task_local]
#京喜财富岛热气球
30 * * * * jd_cfd_loop.js, tag=京喜财富岛热气球, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true
================Loon==============
[Script]
cron "30 * * * *" script-path=jd_cfd_loop.js,tag=京喜财富岛热气球
===============Surge=================
京喜财富岛热气球 = type=cron,cronexp="30 * * * *",wake-system=1,timeout=3600,script-path=jd_cfd_loop.js
============小火箭=========
京喜财富岛热气球 = type=cron,script-path=jd_cfd_loop.js, cronexpr="30 * * * *", timeout=3600, enable=true
 */
