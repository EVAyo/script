...
##############短期活动##############
#特务Zx佳沛 2021年08月3日-2021年08月3日
17 4-23/1 * * * node /scripts/jd_ProductZ4Brand.js >> /scripts/logs/jd_ProductZ4Brand.log 2>&1
...
#来客有礼送豆得豆
43 1,9 * * * node /scripts/jd_sendBeans.js >> /scripts/logs/jd_sendBeans.log 2>&1
# 电竞经理
