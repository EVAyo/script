...
##############短期活动##############
#燃动夏季 活动时间：2021-07-8到2021-08-8
37 7,9,11,13,15,17 * * * node /scripts/jd_summer_movement.js >> /scripts/logs/jd_summer_movement.log 2>&1
...
# 图形验证签到
37 0,9 * * * node /scripts/jd_sign.js >> /scripts/logs/jd_sign.log 2>&1
# 东东超市兑换奖品
