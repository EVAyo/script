...
# 东东世界
33 2,15 * * * node /scripts/jd_ddworld.js >> /scripts/logs/jd_ddworld.log 2>&1
# 京东到家鲜豆任务
...
# 京东到家果园水车水滴
16 */1 * * * node /scripts/jd_jddj_fruit_collectWater.js >> /scripts/logs/jd_jddj_fruit_collectWater.log 2>&1
# 京东到家庄园水滴
