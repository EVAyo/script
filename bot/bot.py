...
# newtime：  2021-04-20
# version：  0.1.6
# log：      新功能-返回上级目录；bot.json增加配置，<代理账号与密码>，已配置好的无需修改,可在 /jd/sample/bot.sample.json 中查看新版本json
...
if proxystart:
    ...
    client = TelegramClient('bot', api_id, api_hash,connection_retries=None).start(bot_token=TOKEN)
cookiemsg = ''
img_file = _qr
