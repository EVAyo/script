...
[task_local]
#京东手机狂欢城
10 0,8 * * * jd_carnivalcity_help.js, tag=京东手机狂欢城, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "10 0,8 * * *" script-path=jd_carnivalcity_help.js, tag=京东手机狂欢城

====================Surge================
京东手机狂欢城 = type=cron,cronexp=10 0,8 * * *,wake-system=1,timeout=3600,script-path=jd_carnivalcity_help.js
