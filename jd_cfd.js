...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://action-1251995682.file.myqcloud.com/shareCodes/cfd.json")
  //if (new Date().getHours() <= 3) res = await getAuthorShareCode('http://cdn.annnibb.me/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/cfd.json')
