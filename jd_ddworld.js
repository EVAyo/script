...
[task_local]
#东东世界
15 3,9 * * * jd_ddworld.js, tag=东东世界, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "15 3,9 * * *" script-path=jd_ddworld.js,tag=东东世界

===============Surge=================
东东世界 = type=cron,cronexp="15 3,9 * * *",wake-system=1,timeout=3600,script-path=jd_ddworld.js

============小火箭=========
东东世界 = type=cron,script-path=jd_ddworld.js, cronexpr="15 3,9 * * *", timeout=3600, enable=true
*/
const $ = new Env('东东世界');
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/ddworld.json')
