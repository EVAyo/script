...
function getRedRainURL() {
  return new Promise(resolve => {
    $.get({url: `https://action-1251995682.file.myqcloud.com/shareCodes/jd-half-rain.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(err)
