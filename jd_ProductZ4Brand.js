...
[task_local]
#特物Z花西子
30 18,19 * * * jd_superBrand, tag=特物Z花西子, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "30 18,19 * * *" script-path=jd_superBrand tag=特物Z花西子

===============Surge=================
特物Z花西子 = type=cron,cronexp="30 18,19 * * *",wake-system=1,timeout=3600,script-path=jd_superBrand

============小火箭=========
特物Z花西子 = type=cron,script-path=jd_superBrand, cronexpr="30 18,19 * * *", timeout=3600, enable=true
