...
[task_local]
#京喜财富岛合成月饼
5 * * * * jd_cfd_mooncake.js, tag=京喜财富岛合成月饼, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "5 * * * *" script-path=jd_cfd_mooncake.js,tag=京喜财富岛合成月饼

===============Surge=================
京喜财富岛合成月饼 = type=cron,cronexp="5 * * * *",wake-system=1,timeout=3600,script-path=jd_cfd_mooncake.js

============小火箭=========
京喜财富岛合成月饼 = type=cron,script-path=jd_cfd_mooncake.js, cronexpr="5 * * * *", timeout=3600, enable=true
 */
...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://action-1251995682.file.myqcloud.com/shareCodes/cfd.json')
